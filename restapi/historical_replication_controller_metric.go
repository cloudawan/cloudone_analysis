...
func registerWebServiceHistoricalReplicationControllerMetric() {
	...
	ws.Route(ws.GET("/{namespace}").To(getAllHistoricalReplicationControllerMetric).
	...
	ws.Route(ws.GET("/{namespace}/{replicationcontroller}").To(getHistoricalReplicationControllerMetric).
